...
import styles from "./TopMenuSecondary.module.scss";
// import { Link } from 'react-scroll';
import Hamburger from "./TopMenuHamburger";
import TopMenuItemsSecondary from "./TopMenuItemsSecondary";
...
class TopMenuSecondary extends React.Component {
  state = {
    ...
    return (
      <>
        ...
        <ul className={topMenuWrapperStyle()}>
          ...
          <TopMenuItemsSecondary openMobileMenu={this.openMobileMenu} />
        </ul>
...
export default TopMenuSecondary;
