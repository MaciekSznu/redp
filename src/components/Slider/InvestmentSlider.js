...
import Slide_03 from "../../assets/images/localization_01_1042_728.jpg";
import Slide_04 from "../../assets/images/interior_01_1042_728.jpg";

class InvestmentSlider extends React.Component {
  render() {
    const settings = {
      // autoplay: true,
      dots: true,
