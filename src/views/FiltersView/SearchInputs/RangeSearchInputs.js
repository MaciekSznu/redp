      ...
      <div className={styles.FiltersWrapper}>
        <div className={styles.FilterFloors}>
          ...
          <div className={styles.FilterValuesWrapper}>
            <span className={styles.FilterValue}>od {filters.selectedFloors.minValue || filters.selectedFloors.min || '0'}</span>
            <span className={styles.FilterValue}>do {filters.selectedFloors.maxValue || filters.selectedFloors.max}</span>
          </div>
        ...
        <div className={styles.FilterArea}>
          ...
          <div className={styles.FilterValuesWrapper}>
            <span className={styles.FilterValue}>od {filters.selectedArea.minValue || filters.selectedArea.min} m<sup>2</sup></span>
            <span className={styles.FilterValue}>do {filters.selectedArea.maxValue || filters.selectedArea.max} m<sup>2</sup></span>
          </div>
        ...
        <div className={styles.FilterPrice}>
          ...
          <div className={styles.FilterValuesWrapper}>
            <span className={styles.FilterValue}>od {filters.selectedPrice.minValue || filters.selectedPrice.min} zł</span>
            <span className={styles.FilterValue}>do {filters.selectedPrice.maxValue || filters.selectedPrice.max} zł</span>
          </div>
