...
const ContactView = () => (
  <>
    <div className={styles.ContactContainer} id="kontakt">
      ...
      <ContactOfficeView className={styles.contactOfficeView} />
      ...
      <ContactFormView className={styles.contactFormView} />
      <ContactVideoView className={styles.contactVideoView} />
    </div>
  </>
);
